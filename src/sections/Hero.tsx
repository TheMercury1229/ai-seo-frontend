...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      transition={{duration:60,repeat:Infinity,ease:"linear"}} className="absolute h-[344px] w-[344px] md:w-[580px] md:h-[580px] border rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-white/20 opacity-20">
        {/* Left Dot */}
      ...
      <motion.div animate={{rotate:"-360deg"}} transition={{duration:80,repeat:Infinity,ease:"linear"}} style={{
        translateY:"-50%",
        translateX:"-50%"
      }} className="absolute w-[444px] h-[444px] md:h-[780px] md:w-[780px] rounded-full border border-white/20 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"></motion.div>
      ...
      transition={{duration:60,repeat:Infinity,ease:"linear"}} className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border border-white/20 rounded-full opacity-20">
        {/* Left Dot */}
        <div className="absolute h-2 w-2 left-0 bg-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2 "></div>
        {/* Top Dot */}
      ...
      <div className="container relative mt-16 mx-auto">
        <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter 
          bg-white
